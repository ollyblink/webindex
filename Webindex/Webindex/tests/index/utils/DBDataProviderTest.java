...
public class DBDataProviderTest {
	...
	public static DBDataManager index;
	public static DBTablesManager dbManager;
...
//
//		for (String doc : docs) {
//			Map<Term, Integer> termFreqs = tokenizer.transform(doc);
...
//		}
//		HashMap<String, List<Document>> documentsForTerms = index.getDocumentsForTerms(terms);
//
//		List<Document> docs = documentsForTerms.get("to");
//		assertTrue(docs.contains(new Document(d1, "")));
//		assertTrue(docs.contains(new Document(d2, "")));
//
//		docs = documentsForTerms.get("do");
//		assertTrue(docs.contains(new Document(d1, "")));
//		assertTrue(docs.contains(new Document(d3, "")));
//		assertTrue(docs.contains(new Document(d4, "")));
//
...
//		Set<Document> documents = index.getAllDocuments();
//		assertEquals(4, documents.size());
//		assertTrue(documents.contains(new Document(d1)));
//		assertTrue(documents.contains(new Document(d2)));
//		assertTrue(documents.contains(new Document(d3)));
//		assertTrue(documents.contains(new Document(d4)));
//	}
//
//	@Test
...
//	}
	...
	public static void tearDown() {
		DBInitializer.tearDownTestDB(index);
	}
