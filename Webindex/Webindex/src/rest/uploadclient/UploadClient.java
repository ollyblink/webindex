...
public class UploadClient {
	private static final int NUMBER_TO_INDEX = 1000;
...
//		String password = "postgres";
		...
		ResultSet r = s.executeQuery("Select * from terms;");
		while(r.next()){
			System.out.println(r.getObject(1));
			System.out.println(r.getObject(2));
			System.out.println(r.getObject(3));
			System.out.println(r.getObject(4));
		}
