...
/**
 * This class combines all the modules developed in this package so that a query and/or metadata of an image can be processed and the corresponding locations are returned as <code>CoordinatePair</code>s
 * 
...
public class YPMPlaceExtractor implements IPlaceExtractor {
	...
	public List<? extends Geometry> extract(String placeNametext) {
		...
		List<Polygon> rectangleList = new ArrayList<Polygon>();
