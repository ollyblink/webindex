...
public class CalaisSoapProxy implements index.spatialindex.utils.placeextractor.calais.CalaisSoap {
  private String _endpoint = null;
  private index.spatialindex.utils.placeextractor.calais.CalaisSoap calaisSoap = null;
  ...
  private void _initCalaisSoapProxy() {
    try {
      calaisSoap = (new index.spatialindex.utils.placeextractor.calais.CalaisLocator()).getcalaisSoap();
      if (calaisSoap != null) {
        if (_endpoint != null)
  ...
  public index.spatialindex.utils.placeextractor.calais.CalaisSoap getCalaisSoap() {
    if (calaisSoap == null)
      _initCalaisSoapProxy();
    return calaisSoap;
  }
