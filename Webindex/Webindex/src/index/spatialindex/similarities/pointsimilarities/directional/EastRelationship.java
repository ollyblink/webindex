...
public class EastRelationship extends AbstractDirectionalRelation {

	public EastRelationship(float multiplicationFactor) {
	...
	protected Point getLowerLeftOfNewQueryPolygon(Point c, Point sw) {
		Point a = gF.createPoint(new Coordinate(c.getX(), sw.getY()));
		return a;
	}
