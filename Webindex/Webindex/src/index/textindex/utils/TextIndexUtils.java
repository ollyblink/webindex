...
public class TextIndexUtils {
	public static Ranking performTextQuery(TextIndexQuery query, ITextTokenizer tokenizer, DBDataProvider dbDataProvider,
		...
		ArrayList<IndexDocument> documents = dbDataProvider.getDocTermKeyValues(transformTermsToStrings(queryTerms), query.isIntersected(),
				spatialRanking);
